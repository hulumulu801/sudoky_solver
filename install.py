...
# если файл скачался, то устанавливаем, если нет - печатаем ошибку, что файла нет
            if not os.path.exists(path + "/" + "tf_nightly-1.13.1-cp36-cp36m-linux_x86_64.whl"):
                print("Файл tf_nightly-1.13.1-cp36-cp36m-linux_x86_64.whl не скачался")
            else:
